...
class LifecycleState(StrEnum):
    DISCOVERED = "DISCOVERED"; INSPECTED = "INSPECTED"; CLASSIFIED = "CLASSIFIED"; MECHANISM_SELECTED = "MECHANISM_SELECTED"; STAGED = "STAGED"; AUDITED = "AUDITED"; VALIDATED_PENDING_CONFIRMATION = "VALIDATED_PENDING_CONFIRMATION"; VALIDATED = "VALIDATED"; GATE_FAILED = "GATE_FAILED"; GATE_PASSED = "GATE_PASSED"; READY_TO_PUBLISH = "READY_TO_PUBLISH"; PUBLISHED = "PUBLISHED"; PUBLISH_FAILED_RECOVERED = "PUBLISH_FAILED_RECOVERED"; PUBLISH_FAILED_UNRECOVERABLE = "PUBLISH_FAILED_UNRECOVERABLE"; AUDIT_COMPLETE_VALID = "AUDIT_COMPLETE_VALID"; AUDIT_COMPLETE_FINDINGS = "AUDIT_COMPLETE_FINDINGS"; AUDIT_COMPLETE_BLOCKING_FINDINGS = "AUDIT_COMPLETE_BLOCKING_FINDINGS"; AUDIT_INCOMPLETE = "AUDIT_INCOMPLETE"; UNCHANGED_VALIDATED = "UNCHANGED_VALIDATED"; UNCHANGED_BLOCKED = "UNCHANGED_BLOCKED"
...
class GateOutcome(StrEnum): READY_TO_PUBLISH = "READY_TO_PUBLISH"; VALIDATED = "VALIDATED"; UNCHANGED_VALIDATED = "UNCHANGED_VALIDATED"; UNCHANGED_BLOCKED = "UNCHANGED_BLOCKED"; REMEDIATION_REQUIRED = "REMEDIATION_REQUIRED"; AUDIT_COMPLETE_VALID = "AUDIT_COMPLETE_VALID"; AUDIT_COMPLETE_FINDINGS = "AUDIT_COMPLETE_FINDINGS"; AUDIT_COMPLETE_BLOCKING_FINDINGS = "AUDIT_COMPLETE_BLOCKING_FINDINGS"; AUDIT_INCOMPLETE = "AUDIT_INCOMPLETE"
...
class ProviderEvidence:
    provider_id: str; capability: str; invocation_phase: str; status: CheckStatus; summary: str; deterministic: bool = False; reproducible: bool = False
@dataclass(frozen=True)
class CheckResult:
